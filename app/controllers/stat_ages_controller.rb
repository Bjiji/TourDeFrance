class StatAgesController < ApplicationController
  ...
  def index
    ...
    tmp = StatMisc.stage_age("leader_id", "asc", limit);
     ...
     tmp = StatMisc.stage_age("climber_id", "asc", limit);
